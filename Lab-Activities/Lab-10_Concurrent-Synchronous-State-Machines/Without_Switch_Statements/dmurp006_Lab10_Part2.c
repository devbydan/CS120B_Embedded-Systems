 ...
 * Lab Sec    -> 027
 * Assignment -> Lab 10, Exercise 2 (Part 2)
 * Purpose    -> Modify the previous exercise so the
 *				 three LEDs light for 300 ms, while
 *				 PB3's LED still blinks 1 second on
 *				 and 1 second off.
 *
 * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
int main(void)
{
	...
	// Function calls ---
	TimerSet(100); // Sets timer to tick every second (Period = 1 second)
